...
namespace FFalcon.XR.Runtime
{
    ...
    public class XRMagCalibrator
    {
        ...
        public XRMagCalibrator(XRCalibratorEvent EventNotifier)
        {
            ...
            Api.RegisterStateEventCallback(DelegatedMethod);
        }

        ~XRMagCalibrator()
        {
            Api.UnregisterStateEventCallback(DelegatedMethod);
        }
        ...
        public bool Start()
        {
            ...
            Api.SendCommand((int)XRControlUnit.kUnitHeadTracker, (int)FXRControlCommand.kCtlCmdStartMagCalibration);
            return true;
        }
        ...
        public bool Stop()
        {
            Api.SendCommand((int)XRControlUnit.kUnitHeadTracker, (int)FXRControlCommand.kCtlCmdStopMagCalibration);
            return true;
        }
